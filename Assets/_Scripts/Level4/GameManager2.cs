...
public class GameManager2 : MonoBehaviour
{
    ...
    // Previous score to track changes
    ...
    public void GameOver(int type)
    {
        ...
        // Call the ShowGameOverCanvas method after a delay
        StartCoroutine(ShowGameOverCanvas(type));
    }

    private IEnumerator ShowGameOverCanvas(int type)
    {
        // Wait for 2 seconds
        yield return new WaitForSeconds(2f);

        // Show the game over canvas after the delay
    ...
    void Update()
    {
        if (playing)
        {
            ...
            {
                // Register the new score in GameManager
                gameManager.RegisterScore(score);
                previousScore = score;
            }
        }
    }
